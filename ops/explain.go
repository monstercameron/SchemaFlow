...
func (opts ExplainOptions) WithIntelligence(intelligence core.Speed) ExplainOptions {
...
// toOpOptions converts ExplainOptions to core.OpOptions
func (opts ExplainOptions) toOpOptions() core.OpOptions {
...
func Explain(data any, opts ExplainOptions) (ExplainResult, error) {
	return explainImpl(core.GetDefaultClient(), data, opts)
}

// ClientExplain is the client-based version of Explain
func ClientExplain(c *core.Client, data any, opts ExplainOptions) (ExplainResult, error) {
	return explainImpl(c, data, opts)
}
...
func generateExplanation(c *core.Client, data any, analysis dataAnalysis, opts ExplainOptions) (explanationResponse, error) {
