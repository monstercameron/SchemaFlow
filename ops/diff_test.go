...
func TestDiff(t *testing.T) {
	...
	core.SetLLMCaller(func(ctx context.Context, system, user string, opts core.OpOptions) (string, error) {
	...
	t.Run("DiffCustomerRecords", func(t *testing.T) {
		...
		result, err := Diff[Customer](oldCust, newCust, NewDiffOptions().WithContext("Customer management system"))
	...
	t.Run("DiffProductCatalog", func(t *testing.T) {
		...
		result, err := Diff[Product](oldProd, newProd, NewDiffOptions().WithContext("E-commerce product catalog"))
	...
	t.Run("DiffWithIgnoredFields", func(t *testing.T) {
		...
		result, err := Diff[Document](oldDoc, newDoc, NewDiffOptions().WithIgnoreFields([]string{"LastUpdated"}))
	...
	t.Run("DiffNoChanges", func(t *testing.T) {
		...
		result, err := Diff[Item](item1, item2, NewDiffOptions())
	...
	t.Run("DiffPrimitiveTypes", func(t *testing.T) {
		...
		result, err := Diff[Config](oldCfg, newCfg, NewDiffOptions())
