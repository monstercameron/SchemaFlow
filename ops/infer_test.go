...
func TestInfer(t *testing.T) {
	...
	t.Run("InferPersonFields", func(t *testing.T) {
		...
		result, err := Infer[Person](partial, NewInferOptions().WithContext("Tech professional"))
	...
	t.Run("InferProductFields", func(t *testing.T) {
		...
		result, err := Infer[Product](partial, NewInferOptions().WithContext("Latest Apple smartphone released in 2023"))
	...
	t.Run("InferWithContext", func(t *testing.T) {
		...
		result, err := Infer[Person](partial, opts)
