...
// addStrikethroughUnicode adds Unicode combining character for strikethrough
// Fallback method if ANSI codes don't work
func addStrikethroughUnicode(text string) string {
