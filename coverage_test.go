...
func TestRecordMetric(t *testing.T) {
	// Save original state
	origMetrics := metricsEnabled
	defer func() { metricsEnabled = origMetrics }()
...
func TestInitWithEnvironmentVariables(t *testing.T) {
	...
	os.Setenv("SCHEMAFLOW_TIMEOUT", "invalid")
	os.Setenv("SCHEMAFLOW_MAX_RETRIES", "invalid")
	os.Setenv("SCHEMAFLOW_RETRY_BACKOFF", "invalid")
	defer func() {
		os.Unsetenv("SCHEMAFLOW_TIMEOUT")
		os.Unsetenv("SCHEMAFLOW_MAX_RETRIES")
		os.Unsetenv("SCHEMAFLOW_RETRY_BACKOFF")
	}()
